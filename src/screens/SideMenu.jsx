            ...
            <>
                <TouchableOpacity style={styles.option} onPress={() => navigation.navigate('Home')}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: hp('1.5%') }}>
                        ...
                        />
                        <Small color={Color('drawerBg')} heading font="bold">Home</Small>
                    </View>
                    <ArrowRight
                        size={hp('3%')}
                ...
                <TouchableOpacity style={styles.option} onPress={() => navigation.navigate('Profile')}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: hp('1.5%') }}>
                        <User
                            ...
                            color={Color('drawerBg')}
                        />
                        <Small color={Color('drawerBg')} heading font="bold">Profile</Small>
                    </View>
                    <ArrowRight
                        size={hp('3%')}
                        color={Color('lightText')}
                ...
                <TouchableOpacity style={styles.option} onPress={() => navigation.navigate('Bookmark')}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: hp('1.5%') }}>
                        <Bookmark
                            ...
                            color={Color('drawerBg')}
                        />
                        <Small color={Color('drawerBg')} heading font="bold">Bookmarks</Small>
                    </View>
                    <ArrowRight
                        size={hp('3%')}
                        color={Color('lightText')}
                ...
                <TouchableOpacity style={styles.option} onPress={() => navigation.navigate('Message', {theme: 'light', title: 'Logout', message: 'Are you sure you want to logout?', screen: 'Logout'})}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: hp('1.5%') }}>
                        ...
                        />
                        <Small color={Color('sidebarLastOption')} heading font="bold">Logout</Small>
                    </View>
                    <ArrowRight
                        size={hp('3%')}
                        color={Color('sidebarLastOption')}
            ...
            <Background translucent={false} bgColor={Color('sidebarBg')} statusBarColor={Color('sidebarBg')} barStyle="dark-content" noBackground>
                <View style={{height: hp('91.5%')}}>
                    ...
                    <Image
                        ...
                        style={{ width: hp('14%'), height: hp('14%'), borderRadius: hp('50%'), alignSelf: 'center' }}
                    />
                    <Br space={1} />
